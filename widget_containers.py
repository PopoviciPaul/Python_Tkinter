...
class Frame_examples_program():
    ...
    def create_widgets(self):
        ...
        frame_label.grid(row=1, column=1, sticky=tk.W, pady=3) # adds padding around the widget in the cell

        frame1 = ttk.Frame(self.window, relief=tk.RIDGE, width=10, height=10)
        frame1.grid(row=2, column=1, sticky=tk.W+tk.E+tk.N+tk.S, padx=30, pady=4)
